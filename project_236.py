...
def generate_lidar_blueprint(blueprint_library):
    ...
    lidar_blueprint.set_attribute('points_per_second', str(56000)) #how many laser beams it emits per second
    lidar_blueprint.set_attribute('rotation_frequency', str(100)) #how fast the beams are moving
    lidar_blueprint.set_attribute('range', str(100)) #how far it can go
